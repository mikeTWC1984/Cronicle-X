...
Class.subclass(Page.Base, "Page.JobDetails", {
	...
	receive_details: function (resp) {
		...
		if (job.log_file_size && (job.log_file_size >= max_log_file_size)) {
			...
			html += '<div style="background-color:black;color:#f2f2f2;background-image: radial-gradient(rgba(47, 79, 79, 0.75), black 120%);font: 1rem Inconsolata, monospace;"><pre id="console_output">test</pre></div>'
