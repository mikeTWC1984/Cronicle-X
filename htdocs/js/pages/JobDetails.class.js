...
Class.subclass(Page.Base, "Page.JobDetails", {
	...
	receive_details: function (resp) {
		...
		if (event.id) html += '<div class="subtitle_widget" style="margin-left:2px;"><a href="#Schedule?sub=edit_event&id=' + event.id +'" target="_blank"><span class="link"><i class="fa fa-edit">&nbsp;</i><b>Edit</b></span></a></div>';
		...
		if (job.log_file_size && (job.log_file_size >= max_log_file_size)) {
			...
			html += '<div style="background-color:black;color:#f2f2f2;background-image: radial-gradient(rgba(47, 79, 79, 0.75), black 120%);font: 1em Inconsolata, monospace;"><pre id="console_output">test</pre></div>'
